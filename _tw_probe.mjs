...
const candidates = ['text-muted','text-subtle','text-fg-muted','text-fg-subtle','line-clamp-5','line-clamp-6','line-clamp-7','line-clamp-8','max-w-screen-2xl','tracking-[0.16em]','text-[13px]','leading-[20px]','text-[25px]','text-[10.5px]','leading-[14px]','tabular-nums','bg-line-strong','min-w-8','gap-x-4','flex-wrap','items-baseline','shrink-0','-mt-1.5','-mr-1.5','max-w-full','text-[16px]','tracking-[-0.01em]','tracking-[-0.015em]','text-pretty','hyphens-auto','line-clamp-3','space-y-12','border-line','text-2xl','text-[24px]','leading-[30px]','mt-2.5','py-3','px-4','min-h-8','bg-elevated','ring-line'];
