/**
 * Workspace → Marketing → Outreach. Admin-only contact directory + lists for
 * cross-promoting BHN programs. One person can sit on many lists without
 * duplication: shared fields live on the person (edit once, updates
