...
export const TALENT_APPLICATION_DEFAULTS = {
  ...
  fields: [
    ...
    },
    {
      id: "career_paths",
      type: "multicheckbox",
      label: "What career path(s) are you interested in?",
      hint: "Select all that apply. Used to match you with industry partners working in those areas.",
      required: true,
      options: [
        ...
        "Regulatory Affairs",
        "Clinical Operations / Clinical Trials",
        "Medical Affairs",
