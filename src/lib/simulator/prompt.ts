...
\`\`\`
{
  ...
  "scenarios": [Scenario, ...],        // 6–8 entries spanning weeks 1..12 (5 minimum)
...
2. **Scenarios cover the full quarter.** At least one scenario in each of weeks 1, 4, 8, 12 (the four anchor weeks). Spread the rest across the remaining weeks. Total 6–8 scenarios (5 minimum). Mix types — don't make them all VP 1:1s.
