...
export const CHANGELOG_ENTRIES: ChangelogEntry[] = [
  {
    title: "Equip deadlines — one-click pre-populate of the standard BHN cadence",
    body: "The deadlines manager at `/admin/equip/deadlines` now has a **Seed standard cadence** button that creates every upcoming deadline through a chosen end-year in one click.\n\n**The cadence** comes straight from the BHN /equip page:\n  • **VentureConnect** — 25th of every month at noon ET. Cycle labels auto-fill as *\"May 2026 cycle\"*, *\"Jun 2026 cycle\"*, etc.\n  • **VentureLift** — 22nd of Feb / May / Aug / Nov at noon ET. Round numbering anchors at Round 1 = May 2025 (program launch), so May 2026 → Round 5, Aug 2026 → Round 6, and the labels carry forward correctly.\n\nDST is handled per-date (the helper round-trips through `America/Toronto` so noon stays at noon whether DST is on or off). The endpoint is **idempotent** — running it again with a later end-year only adds the new tail; dates that already have a deadline for the same stream are kept as-is, so any hand-scheduled overrides survive.\n\nThe seed bar also gives committee members the same one-click option — schedule integrity is the Equip Review committee's job, and they shouldn't need an admin handoff to keep the calendar stocked.",
    kind: "feature",
    visibleTo: ADMINS,
    daysAgo: 0,
  },
