...
export const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    title: "Postings workspace is your new HR home",
    body: "/employer/postings is now the entry point — postings + applicants in one place. Expand any row to see its pipeline; the action queue at the top surfaces new applications, stale stages, and offers still awaiting response. The old /employer brand-stage home was retired 2026-05-21 (it 308-redirects here, so old links still work). The wavy aurora cover banner from that page is archived at /design-archive/employer-cover-banner.html for future reuse.",
    path: "/employer/postings",
    placement: "center",
    since: "2026.05.21d",
    roles: ["employer", "admin", "superadmin"],
    cta: { label: "Open my workspace", href: "/employer/postings" },
  },
  {
    id: "internship-board",
