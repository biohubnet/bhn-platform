...
export const TOUR_STEPS: TourStep[] = [
  // ─── Limited-time June theme · Art Deco — Jun 2026
  {
    ...
    title: "June's limited theme: Steinway",
    body: "A new modern Art Deco theme — bronze + terracotta over warm graphite, drawn from 111 West 57th (the Steinway Tower) — is live through June 30. Open the theme switcher (the swatch in the top bar) and look under \"Limited time\", or tap today's suggestion on your dashboard. It retires when June ends.",
    path: "/dashboard",
    placement: "center",
