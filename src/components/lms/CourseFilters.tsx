  ...
  return (
    <section
      ...
      className={cn(
        ...
        "shadow-[0_8px_28px_-12px_rgba(0,0,0,0.35)]",
      )}
    >
      ...
      <div className="flex items-center gap-2 sm:gap-3 flex-wrap mb-3">
        ...
        <button
          ...
          className={cn(
            ...
            "ring-2 ring-inset",
            selected.special
              ? "bg-amber-400 text-slate-900 ring-amber-300 shadow-[0_0_24px_-4px_rgba(251,191,36,0.7)] scale-[1.02]"
              : "bg-amber-500/10 text-amber-300 ring-amber-500/50 hover:bg-amber-500/20 hover:text-amber-200 hover:ring-amber-400 shadow-[0_0_14px_-4px_rgba(251,191,36,0.4)]",
          )}
        >
          <Sparkles
            size={12}
