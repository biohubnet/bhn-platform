...
const engageItems: (NavItem & { labelKey: string })[] = [
  ...
  { label: "Progress Tracker",   labelKey: "nav.progressTracker", href: "/progress", icon: Activity,
    ...
    description: "Your training-credit utilisation against the 5,000-credit award, the 2,500 / 5,000 milestone dates, and every course you've completed or have in flight. Completed courses export as a PDF." },
