...
const adminPlatformItems: NavItem[] = [
  ...
  { label: "Help nudges",          href: "/admin/assist",              icon: Sparkles,    minRole: "admin",
    description: "Health, helpfulness, and findings for the Help-nudges pipeline (the AI behaviour-watcher that surfaces just-in-time hints when users look stuck). Per-card helpful rate, top stuck surfaces, latest weekly journey summaries, operator actions (run rollup / weekly summary / ad-hoc AI inference)." },
