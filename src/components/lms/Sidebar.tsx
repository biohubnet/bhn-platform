...
const experienceItems: (NavItem & { labelKey: string })[] = [
  ...
  { label: "Resume (structured)",       labelKey: "nav.resumeStructured", href: "/profile/resume",        icon: FileText,
    description: "Edit your resume as a structured tree of sections / items / bullets. AI-parses your uploaded PDF on first visit. Mentors, instructors, and admins can pin comments to any bullet; you decide what to apply." },
